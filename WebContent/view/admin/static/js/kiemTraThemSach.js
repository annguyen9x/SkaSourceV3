...
function ktThemSach(){
	...
	//urlhinh không được rỗng
	var urlhinh =(document.getElementById("urlhinh").value).trim();
	if(urlhinh == "")
	{		
		document.getElementById("errorHinhAnh").innerHTML="Bạn phải tải hình ảnh lên !";
		if( hople ){
			document.getElementById("urlhinh").focus();
		}
		hople = false;
	}
