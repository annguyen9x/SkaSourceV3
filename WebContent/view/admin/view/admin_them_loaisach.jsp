...
<body>
	<%
		...
		String LoiThemLoaiSach = (String)session.getAttribute("LoiThemLoaiSach");
		if( nhanVien != null ){
	%>
	<section class="noidung">
		<div class="container-fluid">
			<div class="row content">
				...
				<!-- Phần nội dung chính -->
					<section class="content trang_them_loaisach">
						<hr>
								...
								<form action="/SachKyAnh/AdminThemLoaiSach" method="post" onsubmit="return ktThemSuaLoaiSach();" accept-charset="utf-8">
									<table class="table table-bordered">
										<tr>
											...
											<td>
												<input type="text" name="maloaisach" id="maloaisach" class="form-control" placeholder="Mã loại sách gồm 4 chữ số (VD: LS05)">
												<span id="errorMaLoaiSach" class="col-xs-12 error warning"></span>
												<%
													if(LoiThemLoaiSach != null){
												%>
														<span class="col-xs-12 error warning">Mã loại sách đã tồn tại, vui lòng nhập mã loại sách khác !</span>
												<%
													}
												%>
											</td>
										...
										<tr>
											...
											<td>
												<input type="text" name="tenloaisach" id="tenloaisach" class="form-control" placeholder="Vui lòng nhập tên loại sách (VD: Sách Tâm Lý)">
