...
@WebServlet(name = "KhoThongTinDH", urlPatterns = { "/KhoThongTinDH" })
public class KhoThongTinDHController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(KiemTraKieuSo.ktKieuSo(soHD) == true) {
			...
			response.sendRedirect("/view/admin/view/kho_xem_thongtin_dh.jsp");
		}
		else {
